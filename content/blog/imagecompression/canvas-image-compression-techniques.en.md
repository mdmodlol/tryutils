...
鈹溾攢鈹€ 1. Image Loading 鈫?Image object or File object
鈹溾攢鈹€ 2. Canvas Drawing 鈫?drawImage() method
鈹溾攢鈹€ 3. Size Adjustment 鈫?Scaling algorithm processing
鈹溾攢鈹€ 4. Quality Control 鈫?toBlob() or toDataURL()
鈹斺攢鈹€ 5. Output Result 鈫?Compressed image data
```
