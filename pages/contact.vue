        ...
        <div class="slide-up">
          ...
          <div class="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div class="card p-8 text-center">
              ...
              <h2 class="text-2xl font-bold text-gray-900 mb-4">{{ $t('contact.email.title') }}</h2>
              <p class="text-gray-600 mb-6">{{ $t('contact.email.description') }}</p>
              <a href="mailto:contact@tryutils.com" class="btn-primary inline-flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                contact@tryutils.com
              </a>
            </div>
            ...
            <div class="card p-8 text-center">
              ...
              <h2 class="text-2xl font-bold text-gray-900 mb-4">{{ $t('contact.social.title') }}</h2>
              <p class="text-gray-600 mb-6">{{ $t('contact.social.description') }}</p>
              <div class="text-gray-500">
                <p>{{ $t('contact.social.comingSoon') }}</p>
                <p class="text-sm mt-2">Telegram • Twitter • GitHub</p>
              </div>
            </div>
          </div>
          ...
          <!-- 联系类型 -->
          <div class="mb-16">
            <h2 class="text-3xl font-bold text-center text-gray-900 mb-12">{{ $t('contact.types.title') }}</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div class="card p-6 text-center hover:scale-105 transition-transform duration-300">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $t('contact.types.suggestion.title') }}</h3>
              ...
              <div class="card p-6 text-center hover:scale-105 transition-transform duration-300">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $t('contact.types.feedback.title') }}</h3>
              ...
              <div class="card p-6 text-center hover:scale-105 transition-transform duration-300">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $t('contact.types.business.title') }}</h3>
              ...
              <div class="card p-6 text-center hover:scale-105 transition-transform duration-300">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $t('contact.types.help.title') }}</h3>
          ...
          <!-- 常见问题引导 -->
          <div class="card p-8 bg-gradient-to-r from-gray-50 to-blue-50 border-0 text-center">
            <h2 class="text-3xl font-bold text-gray-900 mb-6">{{ $t('contact.beforeContact.title') }}</h2>
            ...
            <div class="flex flex-wrap justify-center gap-4">
              ...
              <NuxtLink :to="localePath('/privacy')" class="btn-secondary">
                {{ $t('contact.beforeContact.privacy') }}
              </NuxtLink>
            </div>
          </div>
        </div>
...
useHead({
  ...
  meta: [
    ...
    { name: 'keywords', content: t('contact.meta.keywords') }
  ]
})
</script>