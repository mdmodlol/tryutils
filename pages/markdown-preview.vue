...
const howToSteps = computed<HowToStep[]>(() => [
  { name: t('markdownPreview.howTo.step1.name'), text: t('markdownPreview.howTo.step1.text') },
  { name: t('markdownPreview.howTo.step2.name'), text: t('markdownPreview.howTo.step2.text') },
  { name: t('markdownPreview.howTo.step3.name'), text: t('markdownPreview.howTo.step3.text') },
...
<template>
  <ToolPageShell
    ...
    :bullets="heroBullets"
    :workspace-label="t('markdownPreview.title')"
