...
<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 transition-colors duration-300" itemscope itemtype="https://schema.org/WebPage">
    <main role="main">
      <!-- Hero Section -->
      <section class="py-20 px-6" aria-labelledby="hero-title">
        <div class="max-w-6xl mx-auto text-center">
          <div class="fade-in">
            ...
            <p class="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed" itemprop="description">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16 max-w-4xl mx-auto" role="list" aria-label="{{ t('home.values.title') }}">
              <div class="flex items-center justify-center space-x-3" role="listitem">
                ...
                <div class="text-left">
                  <span class="text-lg font-semibold text-gray-800 dark:text-gray-100 block">{{ t('home.values.free') }}</span>
                  <span class="text-sm text-gray-600 dark:text-gray-400">{{ t('home.values.freeDesc') }}</span>
                </div>
              </div>
              <div class="flex items-center justify-center space-x-3" role="listitem">
                ...
                <div class="text-left">
                  <span class="text-lg font-semibold text-gray-800 dark:text-gray-100 block">{{ t('home.values.secure') }}</span>
                  <span class="text-sm text-gray-600 dark:text-gray-400">{{ t('home.values.secureDesc') }}</span>
                </div>
              </div>
              <div class="flex items-center justify-center space-x-3" role="listitem">
                <div class="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center" aria-hidden="true">
                  <Icon name="heroicons:bolt" class="w-6 h-6 text-white" />
                </div>
                <div class="text-left">
                  <span class="text-lg font-semibold text-gray-800 dark:text-gray-100 block">{{ t('home.values.fast') }}</span>
                  <span class="text-sm text-gray-600 dark:text-gray-400">{{ t('home.values.fastDesc') }}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="py-12 px-6" aria-labelledby="tools-section-title">
        <div class="max-w-6xl mx-auto">
          <div class="text-center mb-12">
            <h2 id="tools-section-title" class="text-4xl font-bold text-gray-900 dark:text-white mb-4">{{ t('home.categories.title') }}</h2>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">{{ t('home.categories.subtitle') }}</p>
          </div>
          ...
          <div class="grid lg:grid-cols-1 gap-12">
            ...
            >
              <!-- 分类卡片 -->
              <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-2xl transition-all duration-300 focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 dark:focus-within:ring-offset-gray-900">
                <div class="p-8">
                  <header class="flex items-center mb-6">
                    ...
                    <div>
                      <h3 :id="`category-${category.id}-title`" class="text-2xl font-bold text-gray-900 dark:text-white mb-2">{{ category.title }}</h3>
                  ...
                  >
                    <NuxtLink 
                      ...
                      class="group p-6 bg-gray-50/50 dark:bg-gray-700/50 rounded-xl hover:bg-white dark:hover:bg-gray-700 hover:shadow-lg transition-all duration-300 border border-transparent hover:border-gray-200 dark:hover:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                      :aria-label="`${tool.name} - ${tool.description}`"
                    >
                      <div class="flex items-start space-x-4">
                        <div 
                          class="w-12 h-12 bg-gradient-to-r from-gray-400 to-gray-600 dark:from-gray-500 dark:to-gray-700 rounded-lg flex items-center justify-center group-hover:from-blue-500 group-hover:to-purple-600 transition-all duration-300"
                          aria-hidden="true"
                        >
      ...
      <!-- 特色功能介绍 -->
      <section class="py-16 px-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900" aria-labelledby="features-title">
        <div class="max-w-6xl mx-auto">
          <div class="text-center mb-12">
            <h2 id="features-title" class="text-4xl font-bold text-gray-900 dark:text-white mb-4">{{ t('home.features.title') }}</h2>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">{{ t('home.features.subtitle') }}</p>
          </div>
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="text-center p-6" role="article" aria-labelledby="feature-1-title">
              <div class="w-16 h-16 bg-gradient-to-r from-green-500 to-teal-600 rounded-full flex items-center justify-center mx-auto mb-4" aria-hidden="true">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m0 0v2m0-2h2m-2 0H10m0-14h4m-4 0V1m4 2h4l2 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5a2 2 0 012-2h4z"/>
                </svg>
              </div>
              <h3 id="feature-1-title" class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ t('home.features.privacy.title') }}</h3>
              <p class="text-gray-600 dark:text-gray-300">{{ t('home.features.privacy.description') }}</p>
            </div>
            ...
            <div class="text-center p-6" role="article" aria-labelledby="feature-2-title">
              ...
              <h3 id="feature-2-title" class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ t('home.features.speed.title') }}</h3>
              <p class="text-gray-600 dark:text-gray-300">{{ t('home.features.speed.description') }}</p>
            </div>
            ...
            <div class="text-center p-6" role="article" aria-labelledby="feature-3-title">
              ...
              <h3 id="feature-3-title" class="text-xl font-semibold text-gray-900 dark:text-white mb-3">{{ t('home.features.quality.title') }}</h3>
              <p class="text-gray-600 dark:text-gray-300">{{ t('home.features.quality.description') }}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-16 px-6" aria-labelledby="cta-title">
        <div class="max-w-4xl mx-auto text-center">
          <h2 id="cta-title" class="text-4xl font-bold text-gray-900 dark:text-white mb-6">{{ t('home.cta.title') }}</h2>
          <p class="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">{{ t('home.cta.description') }}</p>
          <NuxtLink 
            :to="localePath('/image-tools')" 
      ...
      <!-- 统计数据展示 -->
      <section class="py-12 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900" role="region" aria-labelledby="stats-title">
        <div class="max-w-6xl mx-auto px-6 text-center">
          <h2 id="stats-title" class="text-3xl font-bold text-gray-900 dark:text-white mb-8">{{ t('home.stats.title') }}</h2>
          <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-8 shadow-lg">
              <div class="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">10,000+</div>
              <div class="text-gray-600 dark:text-gray-300">{{ t('home.stats.users') }}</div>
            </div>
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-8 shadow-lg">
              <div class="text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2">50,000+</div>
              <div class="text-gray-600 dark:text-gray-300">{{ t('home.stats.files') }}</div>
            </div>
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-8 shadow-lg">
              <div class="text-4xl font-bold text-green-600 dark:text-green-400 mb-2">99.9%</div>
              <div class="text-gray-600 dark:text-gray-300">{{ t('home.stats.uptime') }}</div>
            </div>
          </div>
        </div>
      </section>
