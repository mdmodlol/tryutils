          ...
          <div class="fade-in">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16 max-w-4xl mx-auto" role="list" aria-label="{{ t('home.values.title') }}">
              <div class="flex items-center justify-center space-x-3" role="listitem">
                ...
                <div class="text-left">
                  <span class="text-lg font-semibold text-gray-800 block">{{ t('home.values.free') }}</span>
                  <span class="text-sm text-gray-600">{{ t('home.values.freeDesc') }}</span>
                </div>
              </div>
              <div class="flex items-center justify-center space-x-3" role="listitem">
                ...
                <div class="text-left">
                  <span class="text-lg font-semibold text-gray-800 block">{{ t('home.values.secure') }}</span>
                  <span class="text-sm text-gray-600">{{ t('home.values.secureDesc') }}</span>
                </div>
              </div>
              <div class="flex items-center justify-center space-x-3" role="listitem">
                ...
                <div class="text-left">
                  <span class="text-lg font-semibold text-gray-800 block">{{ t('home.values.fast') }}</span>
                  <span class="text-sm text-gray-600">{{ t('home.values.fastDesc') }}</span>
                </div>
              </div>
            </div>
          </div>
